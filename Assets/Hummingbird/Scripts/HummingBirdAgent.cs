...
{
    [Tooltip("Force aplly when moving ")]
    ...
    public override void OnEpisodeBegin()
    {
        if (trainingMode)
        {
            // Only reset flower in training mode when there is one agent per area
    ...
    /// <summary>
    /// Called when action is recieved from either the player input or the neural network
    /// 
    /// vectorAtion[i] represents:
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        //Calculate pitch adn yaw rotation
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        //Observation a normalized vector pointing to the nearest flower (3 observations)
        ...
        // (+1 means that the beak tip is directly at the flower, -1 means directly away)
    ...
    /// this function will be called. The returned values will be fed into
    ...
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        ...
        //Convert all keyboard inputs to movement and turning
        ...
        //Get actions from ActionBuffers
        var vectorActions = actionsOut.ContinuousActions;

        // Add the 3 movement values, pitch and yaw to the actionOut array
        vectorActions[0] = combined.x;
        vectorActions[1] = combined.y;
        vectorActions[2] = combined.z;
        vectorActions[3] = pitch;
        vectorActions[4] = yaw;
    ...
    private void MoveToSafeRandomPosition(bool inFrontOfFlower)
    {
        ...
        while (!safePositionFound && attemptsRemaining > 0)
        {
            ...
            else
            {
                ...
                //Combine height, raidus,  and direction to pick a potential position
    ...
    /// <summary>
    /// Called when the agent collides with something odd
    /// </summary>
